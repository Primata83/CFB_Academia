...
namespace Editor_de_Texto
{
    public partial class Form1 : Form
    {
        ...
        private void Salvar()
        {
            try
            {
                if (this.saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    StreamWriter cfb_streamWrite = new StreamWriter(arquivo);
                    cfb_streamWrite.Flush();
                    cfb_streamWrite.BaseStream.Seek(0, SeekOrigin.Begin);
                    cfb_streamWrite.Write(this.richTextBox1.Text);
                    cfb_streamWrite.Flush();
                    cfb_streamWrite.Close();
                }
            } catch (Exception ex)
            {
        ...
        private void Abrir()
        {
            ...
            openFileDialog1.InitialDirectory = @"C:\Users\User-PC\Documents\Aulas C#\PARTE 2\Componentes\Editor de Texto\";
            openFileDialog1.Filter = "(*.83)|*.83";
